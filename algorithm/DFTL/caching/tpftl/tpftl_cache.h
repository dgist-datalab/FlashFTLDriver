...
bool tp_is_needed_eviction(struct my_cache *, uint32_t , uint32_t *);
bool tp_is_needed_more_eviction(struct my_cache *, uint32_t);
uint32_t tp_update_entry(struct my_cache *, GTD_entry *, uint32_t lba, uint32_t ppa);
uint32_t tp_update_entry_gc(struct my_cache *, GTD_entry *, uint32_t lba, uint32_t ppa);
uint32_t tp_insert_entry_from_translation(struct my_cache *, GTD_entry *, uint32_t lba, char *data, uint32_t *);
